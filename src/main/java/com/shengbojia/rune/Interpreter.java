...
import com.shengbojia.rune.callables.*;
import com.shengbojia.rune.throwables.Break;
...
import com.shengbojia.rune.token.TokenType;
...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    Interpreter() {
        ...
        globals.define("clock", new RuneCallable() {
            @Override
            public int arity() {
                return 0;
            }
    ...
    void interpret(List<Stmt> statements) {
        try {
            ...
            Rune.runtimeError(error);
        }
    }

    private String makeIntoString(Object o) {

        // Special cases for nil and Rune numbers
        if (o == null) {
            return "nil";
        }
        ...
        if (o instanceof Double) {
            ...
            // Make it into Rune-style integer double
            if (text.endsWith(".0")) {
        ...
        // Everything else is same in Rune as java
        return o.toString();
    }
    ...
    public Void visitFunctionStmt(Stmt.Function stmt) {
        RuneFunction function = new RuneFunction(stmt, environment);
    ...
    public Void visitVarStmt(Stmt.Var stmt) {
        ...
        // Rune allows variables to be declared without initialization
    ...
    public Object visitSetExpr(Expr.Set expr) {
        ...
        if (!(object instanceof RuneInstance)) {
            throw new RuntimeError(expr.name, "Only instances have fields.");
        }

        Object value = evaluate(expr.value);
        ((RuneInstance) object).setField(expr.name, value);
    ...
    public Object visitUnaryExpr(Expr.Unary expr) {
        ...
        switch (expr.operator.type) {
            ...
            case MINUS:
                ...
                // Rune is dynamically typed, hence the casting which occurs at runtime
                return -(double) right;
        }
    ...
    /**
     * Rune is similar to Ruby: 'false' and 'nil' are falsey and everything else is truthy.
     *
    ...
    /**
     * Rune equality '==' is defined as follows: For any non-null x, y, z, we have
     * <p>
    ...
    public Object visitCallExpr(Expr.Call expr) {
        ...
        if (!(callee instanceof RuneCallable)) {
            throw new RuntimeError(expr.paren,
                    "Can only call functions and classes.");
        }
        RuneCallable function = (RuneCallable) callee;
    ...
    public Object visitGetExpr(Expr.Get expr) {
        Object object = evaluate(expr.object);
        if (object instanceof RuneInstance) {
            return ((RuneInstance) object).getProperty(expr.name);
        }
