...
import com.shengbojia.rune.throwables.ParseError;
 ...
 * ;    not to be confused with the Rune statement end ';', this is a metalanguage symbol indicating end of current rule
 */
public class Parser {
    ...
    private Expr finishCall(Expr callee) {
        ...
        if (!check(RIGHT_PAREN)) {
            do {
                // java has a max argument size of 255, let's have 32 on Rune
    ...
    /**
     * Sends an error to Rune to be reported.
     *
