...
import static com.shengbojia.rune.token.TokenType.*;

/**
 * Scanner that consumes a .rune file in string format, and turns the content into a sequence of tokens.
 */
public class Scanner {
     ...
     * commented out text.
     * <p>
     * Rune follows C-style commenting, so supports // and /* .. * / comments.
     */
     ...
     * the decimal, since Rune allows for number method calls. (eg 140.abs())
     * <p>
     * Rune has only floating point numbers. Allows for integer and decimal literals, but no leading/trailing decimals.
     ...
     * Rune before adding the appropriate type of token to the list of tokens.
     * <p>
     * Rune allows for identifiers to start with an underscore. So _myVar is fine.
     */
